...
## 레퍼런스
C 언어에서 주소 연산자로 사용되었던 &는 C++에서 좌항에도 사용됩니다.  
...
이러한 경우를 대비해 C++는 사용자 정의 소멸자를 제공해 명시적으로 메모리를 회수하도록 유도합니다.  
...
## friend 
C++만의 독특한 키워드인 friend는 단방향적으로 선언되며 피선언된 (친구) 클래스는
선언된 클래스의 private 제한제에도 접근이 가능합니다.  

## 디폴트 복사 생성자
C++는 디폴트 생성자 및 소멸자 뿐만 아니라 복사 생성자를 제공하여 값을 복사할 수 있습니다.  
