...
description: 
cover: /assets/post_img/lua.PNG
tags: lua
comments: true
article-comments: true
---
<center><img src="{{site.baseurl}}/assets/post_img/lua.PNG"></center>
...
## 개요
이 문서는 스크립트 언어인 [루아(Lua)](http://www.lua.org/manual/5.3/)를 공부하며 기술하였습니다.  
## 특징
...
make install
~~~
WIN 환경에서는 [코드](https://code.google.com/archive/p/luaforwindows/)를 다운 받아 윈도우용 콘솔인 lua.exe를 실행합니다.  
